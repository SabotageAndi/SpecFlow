...
namespace TechTalk.SpecFlow.Specs.Drivers
{
    public class MsTestTestExecutionDriver
    {
        ...
        public MsTestTestExecutionDriver(InputProjectDriver inputProjectDriver, TestExecutionResult testExecutionResult, Folders folders, VisualStudioFinder visualStudioFinder)
        {
